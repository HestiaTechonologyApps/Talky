...
const StaffEdit: React.FC = () => {
  ...
  const fields = [
    ...
    { name: "companyCoinsPerSecondVideo", rules: { required: false, type: "number" as const, label: "Company Deduction Per Second Video" } },
    { name: "companyCoinsPerSecondAudio", rules: { required: false, type: "number" as const, label: "Company Deduction Per Second Audio" } },
